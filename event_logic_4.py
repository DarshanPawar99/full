...
def event_logic_4(df_selected_month, analysis_df, months_to_include):
    
    # Sidebar dropdown for site name
    selected_site = st.sidebar.selectbox("Select Site Name", df_filtered['site name'].unique())

    # Filter dataframe by selected site
    df_filtered = df_filtered[df_filtered['site name'] == selected_site]
