...
def display_dataframes(pivot_df, mismatched_data, karbon_expenses_data, aggregated_data, buying_value_issues, selling_value_issues, popup_selling_issues, high_buying, summary_df, session_wise_df):
    st.write("Buying is on Actual Consumption")
    st.write("Selling is on Actual Consumption")
    st.write("We recive Management fee of Selling Amount")
    st.markdown("---")
...
def business_logic_28(df_selected_month, analysis_df, months_to_include):
