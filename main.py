    ...
    business_logic_sheets = {
        ...
        # Map sheet names to business logic module names
            ...
            "business_logic_4": ["Medtrix","MG Eli Lilly", "Awfis","Amadeus","Ather - Main Meal","Ajuba",
                                 ...
                                 "L & T Executive Lunch", "DTCC Pantry Hyd","Cigna ","Kongsberg ","DTCC Wallet Hyd","Cognizant","IKEA Sample","Stryker_blr","AMADEUS TRAIL","Cargill Tea & Coffee"],
            ...
            "business_logic_28": ["CSG-Pune","Cargill Guest ordering"],
            ...
            "business_logic_35": ["Cargill MRP"],
            "business_logic_36": ["Stryker"],
            "business_logic_37": [""],
            "business_logic_38": ["Truecaller"],
            "business_logic_39": ["Cargill"],
