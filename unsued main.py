    ...
    business_logic_sheets = {
        ...
        # Map sheet names to business logic module names
            ...
            "business_logic_2": ["Odessa","Scaler-Prequin","Quzizz","Ather Mumbai","Groww Mumbai.","MPL-Delhi",
                                 "Tadano","Epam", "O9 Solutions","Telstra Event sheet",],
            ...
            "business_logic_4": ["Medtrix","MG Eli Lilly", "Awfis","Amadeus","Ather - Main Meal","Ajuba",
                                 ...
                                 "Clario","Dynasty", "Citrix Driver's Lunch & Dinner","Citrix-Tuckshop","MIQ","Vector","Lam Research","HD Works","Synergy",
                                 "DTCC Company Paid",],
           
            "business_logic_5": ["Microchip Main Meal"],
            "business_logic_6": ["Plain View"],
            "business_logic_7": ["MPL"],
            "business_logic_8": ["Tadano Escorts"],
            "business_logic_9": ["Rippling","Tessolve","Corning","Pratilipi","SAEL Delhi"],
            ...
            "business_logic_30": ["Toasttab","Gartner"],
            "business_logic_31": [""],
    ...
    try:
        ...
        if hasattr(module, 'punch_pnl_data_to_blank_row') and hasattr(module, 'clear_pnl_data'):
            ...
            if 'review id' in df_filtered.columns:
                df_filtered['identifier'] = df_filtered['review id'].combine_first(df_filtered['cost centre'])
            ...
            # Handle multiple identifiers: allow selection if more than one
            unique_identifiers = df_filtered['identifier'].unique()
            if len(unique_identifiers) > 1:
                identifier = st.selectbox("Select Identifier", unique_identifiers)
            else:
