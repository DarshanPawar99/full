...
def display_dataframes(pivot_df, mismatched_data, aggregated_data, buying_value_issues, selling_value_issues, popup_selling_issues, high_buying, summary_df, session_wise_df):
...
def business_logic_53(df_selected_month, analysis_df, months_to_include):
...
def clear_pnl_data(p_and_l_file_path, month):
    ...
    try:
        ...
        columns_to_clear = [
            ...
            'event selling amount', 'penalty on vendor', 'penalty on smartq',
        ]
